    ...
    <div className="  bg-[#F5E1C8] h-8 sm:h-[40px] lg:h-14">
      ...
      <div className=" flex flex-row items-center text-sm sm:text-base lg:text-lg font-normal font-poppins gap-2 sm:gap-3 lg:gap-4">
        ...
        <div className="flex flex-row items-center gap-3 sm:gap-5 lg:gap-6 text-sm sm:text-base lg:text-xl">
            <Link href={'/'} className=" hover:text-[#D35400] hover:bg-[#242424] border bg-white p-1 sm:p-[6px] lg:p-2 rounded-full"><LuFacebook  /></Link>
            <Link href={'/'} className=" hover:text-[#D35400] hover:bg-[#242424] border bg-white p-1 sm:p-[6px] lg:p-2 rounded-full"><FaWhatsapp /></Link>
            <div  className=" hover:text-[#D35400] hover:bg-[#242424] border bg-white p-1 sm:p-[6px] lg:p-2 rounded-full"><FaXTwitter /></div>
        </div>
      </div>
    </div>
       ...
       {/* Drawer & Menu section */}
        ...
        className="menu !w-[200px] sm:!w-[250px] !bg-[#F5E1C8]">
             <div className="flex flex-row items-center">
            <Image src={'/logo2.png'} alt="logo" width={50} height={50} className="w-[30px] sm:w-[50px] lg:w-[80px] h-[30px] sm:h-[50px] lg:h-[80px] "/>
            <h1 className="text-xl sm:text-3xl text-[40px] font-bold font-poppins text-[#222222]">ZiranGo</h1>
        </div>
      <hr className="  my-2"/>
        <div className=" flex flex-col  gap-3 my-6 ">
            {
                linkNav.map((links) => (
                    <Link href={links.href} key={links.id} className="text-sm sm:text-base md:text-lg font-medium font-poppins border border-[#FA8232] rounded-sm text-[#222222] hover:text-[#D35400] p-1">
                        <div className="hover:bg-[#a8a8a8] rounded-md py-1 px-3">
                            {links.name}
                        </div>
                    </Link>
                ))
